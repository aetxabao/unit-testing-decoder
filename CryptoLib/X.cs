    ...
    public class X
    {
        ...
        {   
            ...
            using (RSACryptoServiceProvider tester = new RSACryptoServiceProvider())
            {
                ...
                return base64; //devuelve el texto encriptado mediante el RSA
            }          
        }
        ...
        public static string RsaDecrypt(string code, RSACryptoServiceProvider rsa)
        {
            ...
            string textodesencriptado = Encoding.UTF8.GetString(decrypted);
            return textodesencriptado; //devuelve el texto con RSA(el texto que el usuario elija)
        ...
        public static string SignedData(string text, RSACryptoServiceProvider rsa)
        {
            ...
            return base64; //encripta con clave prviada para firmarlo(para demostrar que el texto es tuyo)
        ...
        public static bool VerifyData(string text, string signedText, string pubParsXml)
        {
            ...
            tester.ImportParameters(RsaParsFromXml(pubParsXml));
            return tester.VerifyData(data, new SHA1CryptoServiceProvider(), signedData);//verifica utilizando la clave publica que la firma coincide con el propietario
        ...
        public static string ShaHash(Object input)
        {
            ...
            return sBuilder.ToString(); // devuelve cel codigo hash del texto
